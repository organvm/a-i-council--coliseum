...
class CreateVotingSessionRequest(BaseModel):
    ...
    description: str
    vote_type: VoteType
    options: List[str] = Field(min_length=2, max_length=20, description="List of voting options (2-20)")
...
class CastVoteRequest(BaseModel):
    ...
    tokens_staked: float = Field(default=0.0, ge=0.0, description="Tokens staked (must be non-negative)")
