...
class Agent(BaseAgent):
    ...
    def __init__(
        ...
        self.system_prompt = config.get("system_prompt", f"You are an AI agent acting as a {role}.") if config else f"You are an AI agent acting as a {role}."
        self.name = config.get("name", f"{role.capitalize()} Agent") if config else f"{role.capitalize()} Agent"
