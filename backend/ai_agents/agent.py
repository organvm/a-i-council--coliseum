...
class Agent(BaseAgent):
    ...
    def __init__(
        ...
        # config is initialized in super().__init__ if it was None
        self.system_prompt = self.config.get("system_prompt", f"You are an AI agent acting as a {role}.")
        self.name = self.config.get("name", f"{role.capitalize()} Agent")
